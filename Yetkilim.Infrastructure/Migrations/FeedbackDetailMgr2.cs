...
// Type: Yetkilim.Infrastructure.Migrations.FeedbackDetailMgr2
...
namespace Yetkilim.Infrastructure.Migrations
{
  ...
  [Migration("20190114204212_FeedbackDetailMgr2")]
  public class FeedbackDetailMgr2 : Migration
  {
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.InsertData("FeedbackForms", new string[3]
      {
        "Id",
        "CompanyId",
        "CreatedDate"
      }, new object[3]
      {
        (object) 1,
        (object) 1,
        (object) new DateTime(2019, 1, 14, 23, 42, 12, 30, DateTimeKind.Local).AddTicks(2710L)
      }, (string) null);
    ...
    {
      migrationBuilder.UpdateData("Companies", "Id", (object) 1, "CreatedDate", (object) new DateTime(2019, 1, 14, 23, 30, 23, 779, DateTimeKind.Local).AddTicks(350L), (string) null);
      migrationBuilder.UpdateData("FeedbackForms", "Id", (object) 1, "CreatedDate", (object) new DateTime(2019, 1, 14, 23, 30, 23, 795, DateTimeKind.Local).AddTicks(1542L), (string) null);
      migrationBuilder.UpdateData("PanelUser", "Id", (object) 1, "CreatedDate", (object) new DateTime(2019, 1, 14, 23, 30, 23, 781, DateTimeKind.Local).AddTicks(2174L), (string) null);
    }
    ...
    protected override void BuildTargetModel(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity("Yetkilim.Domain.Entity.Company", (Action<EntityTypeBuilder>) (b =>
      {
        ...
        b.HasData((object) new
        {
          ...
          CompanyTypeId = 1,
          CreatedBy = "Seed",
          CreatedDate = new DateTime(2019, 1, 14, 23, 42, 12, 15, DateTimeKind.Local).AddTicks(7474L),
          Name = "Yetkilim A.Ş"
        });
      }));
      ...
      modelBuilder.Entity("Yetkilim.Domain.Entity.FeedbackForm", (Action<EntityTypeBuilder>) (b =>
      {
        ...
        b.HasData((object) new
        {
          Id = 1,
          CompanyId = 1,
          CreatedDate = new DateTime(2019, 1, 14, 23, 42, 12, 30, DateTimeKind.Local).AddTicks(2710L)
        });
      }));
      modelBuilder.Entity("Yetkilim.Domain.Entity.PanelUser", (Action<EntityTypeBuilder>) (b =>
      {
        ...
        b.HasData((object) new
        {
          Id = 1,
          CompanyId = 1,
          CreatedDate = new DateTime(2019, 1, 14, 23, 42, 12, 17, DateTimeKind.Local).AddTicks(7959L),
