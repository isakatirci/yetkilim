...
// Type: Yetkilim.Infrastructure.Migrations.UserShareOnFeedbackMgr
...
namespace Yetkilim.Infrastructure.Migrations
{
  ...
  [Migration("20190110213506_UserShareOnFeedbackMgr")]
  public class UserShareOnFeedbackMgr : Migration
  {
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      migrationBuilder.AddColumn<bool>("IsUserShare", "Feedbacks", (string) null, new bool?(), new int?(), false, (string) null, false, (object) false, (string) null, (string) null, new bool?());
    ...
    {
      migrationBuilder.DropColumn("IsUserShare", "Feedbacks", (string) null);
    ...
    protected override void BuildTargetModel(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity("Yetkilim.Domain.Entity.Company", (Action<EntityTypeBuilder>) (b =>
      {
        ...
        b.HasData((object) new
        {
          ...
          CompanyTypeId = 1,
          CreatedBy = "Seed",
          CreatedDate = new DateTime(2019, 1, 11, 0, 35, 5, 726, DateTimeKind.Local).AddTicks(6245L),
          Name = "Yetkilim A.Ş"
        });
      }));
      ...
      modelBuilder.Entity("Yetkilim.Domain.Entity.PanelUser", (Action<EntityTypeBuilder>) (b =>
      {
        ...
        b.HasData((object) new
        {
          Id = 1,
          CompanyId = 1,
          CreatedDate = new DateTime(2019, 1, 11, 0, 35, 5, 728, DateTimeKind.Local).AddTicks(7116L),
