	...
	** Scroll top
    ...
    function getLocation() {
        if (navigator.geolocation) {
            ...
            alert("Tarayıcınızın konum desteği bulunmuyor.");
        }
    }
    ...
    function errorLocation(error) {
        ...
        switch (error.code) {
            case error.PERMISSION_DENIED:
                ...
                message = "Telefonunuzun konum izinlerinin açık olduğuna emin olun. Kontrol etmek için: Ayarlar->Gizlilik-> Konum Servisleri-> Tarayıcınız(Safari ya da diğerleri) -> Konuma izin ver.";
                break;
            ...
            case error.TIMEOUT:
                constant = "TIMEOUT";
                message = "Konum bulma zaman aşımına uğradı.";
                break;
            default:
